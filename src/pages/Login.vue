    ...
    <view class="canteiner">
      ...
      <u-popup :show="popupShow" mode="bottom">
        <scroll-view scroll-y style="height: calc(100vh - 310rpx)">
          <view class="popup">
            <h1>隐私政策</h1>
            <div>更新日期：<strong>2023/10/11</strong></div>
            <div>生效日期：<strong>2023/10/11</strong></div>
            <h2>导言</h2>
            <p>
              <i>韬哥金轮</i> 是一款由
              <i>高裕韬，邓俊杰</i> （以下简称“我们”）提供的产品。
            ...
            <p>
              ...
              <strong>17324113904</strong> 与我们联系。
            </p>
        ...
        <view class="but">
          <u-button type="primary" size="mini" @click="popupOk">
            确定
          </u-button>
        </view>
      </u-popup>
...
const sub = async () => {
  if (!form.passWord || !form.mobile) {
    ...
    return uni.showToast({ icon: 'none', title: '请先同意用户协议' });
  }
